	...
	<nav class="navbar navbar-inverse navbar-fixed-top" style="font-size: 16px;">
	  <div class="container">
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand active" href="index.php" style="font-size: 18px;">YourFood</a>
	    </div>
	    <div class="collapse navbar-collapse" id="myNavbar">
	      <ul class="nav navbar-nav navbar-right">
	      	<li><a href="restaurant-signup.php">For Resturents</a></li>
	        <li><a href="user-signup.php"><span class="glyphicon glyphicon-user"></span> Try Now</a></li>
	        <li><a href="user-login.php"><span class="glyphicon glyphicon-log-in"></span> Sign in</a></li>
			<li><a href="user-login.php"><span class="glyphicon glyphicon-earphone"></span> Contact us</a></li>
	      </ul>
	    </div>
	  </div>
	</nav><br><br><br>
